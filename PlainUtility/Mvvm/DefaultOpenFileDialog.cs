...
namespace Mvvm
{
    ...
    public class DefaultOpenFileDialogRequest : Request
    {
        public DefaultOpenFileDialogRequest()
            : base(typeof(OpenFileDialogMessage), typeof(OpenFileDialogMessage), ActionHnadler)
        {
        ...
        private static void ActionHnadler(IMessage message)
        {
            ...
            dialog.CheckFileExists = msg.CheckFileExists;
            dialog.CheckPathExists = msg.CheckPathExists;
            dialog.CustomPlaces = msg.CustomPlaces;
            dialog.DefaultExt = msg.DefaultExt;
            dialog.DereferenceLinks = msg.DereferenceLinks;
            dialog.FileName = msg.FileName;
            dialog.Filter = msg.Filter;
            dialog.FilterIndex = msg.FilterIndex;
            dialog.InitialDirectory = msg.InitialDirectory;
            dialog.Multiselect = msg.Multiselect;
            dialog.ReadOnlyChecked = msg.ReadOnlyChecked;
            dialog.RestoreDirectory = msg.RestoreDirectory;
            dialog.ShowReadOnly = msg.ShowReadOnly;
            dialog.Title = msg.Title;
            dialog.ValidateNames = msg.ValidateNames;
